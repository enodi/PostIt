  ...
  render() {
    return(
      ...
      <div className="parallax-container valign-wrapper">
         <div className="parallax"><img src={require("../../assets/images/product.jpg")}/></div>
       </div><br/><br/>
         ...
         <div className="row">
           ...
           <div className="col l12">
             ...
             <div className="col l7 s12">
               <img src={require("../../assets/images/group.jpg")} className="responsive-img"/>
             </div>
           </div>
           ...
           <div className="col l12">
             ...
             <div className="col l7 s12">
               <img src={require("../../assets/images/message.jpg")} className="responsive-img"/>
             </div>
           </div>
         </div>
       </div>
       ...
       <div className="platform-background z-depth-2">
             ...
             <p>Use PostIt on any device</p><br/>
   					<img src={require("../../assets/images/devices.png")} className="circle responsive-img"/>
   				</div>
   			</div>
   		</div><br/>
      </div>
